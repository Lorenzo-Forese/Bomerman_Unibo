...
private:
	...
	//	char istruzioni2[] = " s  "; 
		...
		mvaddstr( winpos + 14 , (mainwin.scr_x - strlen(line.c_str()) ) /2 , line.c_str() );
		attroff(A_BOLD | A_STANDOUT);
		mvaddstr( winpos + 27 , ((mainwin.scr_x - strlen(istruzioni)) /2) , istruzioni);
	//	mvaddstr( 28 , (mainwin.scr_x - strlen(istruzioni2)) /2 , istruzioni2);
		attron(A_UNDERLINE);
		mvaddstr( winpos + 24 , (mainwin.scr_x /2 - 1) , lingua.lingua.c_str() ); 
		attroff(A_UNDERLINE);
	}
